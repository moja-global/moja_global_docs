...
- The `FLINT  core repository <https://github.com/moja-global/FLINT>`_ has been forked and cloned following the Git and Github guide `here <git_and_github_guide.html>`_.
